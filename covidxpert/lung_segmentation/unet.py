...
from tensorflow.keras.layers import Conv2D, MaxPooling2D, concatenate, Conv2DTranspose, Input
import os
from .dice_coef import dice_coef, dice_coef_loss
...
def unet(input_size=(512, 512, 1)):
    ...
    model.load_weights(
        "{}/cxr_reg_weights.best.hdf5".format(
